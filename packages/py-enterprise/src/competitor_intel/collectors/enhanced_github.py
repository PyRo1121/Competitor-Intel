"""Enhanced GitHub collector — deep repo analysis with language detection and contributor insights."""
...
class EnhancedGitHubCollector(BaseCollector):
    ...
    async def _analyze_repo(self, company: str, repo_path: str) -> list[dict[str, Any]]:
        ...
        releases_response = await self.fetch(releases_url, headers=headers, params={"per_page": "10"})
