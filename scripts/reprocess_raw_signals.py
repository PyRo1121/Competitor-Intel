#!/usr/bin/env python3
"""
Reset raw_signals that were marked processed without a linked intelligence_event.

Use after fixing signal_processor or schema drift so extraction can run again.
"""
...
logger = logging.getLogger("reprocess_raw_signals")
ensure_app_paths()
...
def reset_without_event(conn, *, dry_run: bool) -> int:
    """Re-queue any raw_signal that never produced an intelligence_event."""
